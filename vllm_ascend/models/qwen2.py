...
class CostomQwen2MLP(nn.Module):
...
class CostomQwen2Attention(nn.Module):
    ...
    def forward(
        ...
        if self.torchair_graph_enabled and attn_metadata is not None and attn_metadata.attn_state == AscendAttentionState.DecodeOnly:
            ...
            attn_output = self.attn.impl.forward(self.attn, q, k, v,
                                                 kv_cache=kv_cache,
...
class CostomQwen2DecoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.self_attn = CostomQwen2Attention(
...
class CostomQwen2Model(nn.Module):

    def __init__(self,
                 *,
                 vllm_config: VllmConfig,
                 prefix: str = "",
                 decoder_layer_type: type[nn.Module] = CostomQwen2DecoderLayer):
        super().__init__()
        ...
        decoder_layer_type = CostomQwen2DecoderLayer
...
class CustomQwen2ForCausalLM(nn.Module, SupportsLoRA, SupportsPP):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.quant_config = quant_config
        self.model = CostomQwen2Model(vllm_config=vllm_config,
